...
namespace Samples {
    void GirlController::Update(float_t dt) {
        ...
        const bool isPlayMode = SR_UTILS_NS::Input::Instance().IsPlayMode();
    ...
    void GirlController::FixedUpdate() {
        SR_TRACY_ZONE;
        ...
        const bool isWPressed = isPlayMode && SR_UTILS_NS::Input::Instance().GetKey(SR_UTILS_NS::KeyCode::W);
        const bool isSPressed = isPlayMode && SR_UTILS_NS::Input::Instance().GetKey(SR_UTILS_NS::KeyCode::S);
        const bool isAPressed = isPlayMode && SR_UTILS_NS::Input::Instance().GetKey(SR_UTILS_NS::KeyCode::A);
        const bool isDPressed = isPlayMode && SR_UTILS_NS::Input::Instance().GetKey(SR_UTILS_NS::KeyCode::D);
        ...
        const bool isShift = isPlayMode && SR_UTILS_NS::Input::Instance().GetKey(SR_UTILS_NS::KeyCode::LShift);
        ...
        const float_t dt = SR_HTYPES_NS::Time::Instance().FixedDeltaTime();
